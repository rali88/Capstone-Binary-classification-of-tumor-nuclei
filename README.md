...
## Deliverables   
    1- [Jupyter notebook with code, markdowns and figures](../blob/master/Tumor%20classification.ipynb)   
    
    2- [A final analysis report describing the methodology used and the results obtained from the analysis](../blob/master/Analysis%20report.pdf)   
